...
<!-- 开发环境 -->
<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.199.150:8080"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.199.150:8080/mvc"/>
<!-- 生产环境 -->
<!-- 
